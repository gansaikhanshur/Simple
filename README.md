![simple logo](img/simple_logo.png)
...
`simple` is the easiest way to securely configure your Mac.
...
1. Install with [`pip`](https://pypi.org/project/simple/)
    + `$ pip install simple`
    + `$ simple`

2. Download the `simple` binary from Releases tab.
...
1. Clone repo and create a new branch: `$ git checkout https://github.com/alichtman/simple -b name_for_new_branch`.
...
+ [drduh's macOS-Security-and-Privacy-Guide](https://github.com/drduh/macOS-Security-and-Privacy-Guide) and [Jonathan Levin's MacOS Security Guide](http://newosxbook.com/files/moxii3/AppendixA.pdf) were incredibly helpful while I was building `simple`.
